 ...
 * method visibility is narrowed to package if not needed in other packages
 */
class MailGenerator {

    final int MAIL_TO_CREATE;
     ...
     */
    MailGenerator(int mailToCreate, IMailPool mailPool, HashMap<Boolean, Integer> seed, boolean fragile){
