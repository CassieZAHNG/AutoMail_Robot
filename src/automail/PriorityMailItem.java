package automail;
/*
 * PriorityMailItem defines priorityMailItem and its components.
 * Constructor visibility is narrowed to package
 */
...
public class PriorityMailItem extends MailItem{
	...
	PriorityMailItem(int dest_floor, int arrival_time, int weight, boolean fragile, int priority_level) {
